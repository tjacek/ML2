-file("/usr/lib/erlang/lib/parsetools-2.0.1/include/leexinc.hrl", 0).
...
-file("./data_scanner.xrl", 22).

-file("/usr/lib/erlang/lib/parsetools-2.0.1/include/leexinc.hrl", 14).
...
yystate(18, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [95|Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [45|Ics], Line, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [44|Ics], Line, Tlen, Action, Alen) ->
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(12, Ics, Line, Tlen+1, 10, Tlen);
...
-file("./data_scanner.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { known, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./data_scanner.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { known, TokenLine, list_to_atom (string : strip (TokenChars, both, 39)) } } .

-compile({inline,yyaction_2/1}).
-file("./data_scanner.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { unknown, TokenLine } } .

-compile({inline,yyaction_3/2}).
-file("./data_scanner.xrl", 10).
yyaction_3(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./data_scanner.xrl", 11).
yyaction_4(TokenChars, TokenLine) ->
     { token, { known, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_5/0}).
-file("./data_scanner.xrl", 12).
yyaction_5() ->
     { error, "Empty string" } .

-compile({inline,yyaction_6/1}).
-file("./data_scanner.xrl", 13).
yyaction_6(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./data_scanner.xrl", 14).
yyaction_7(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("./data_scanner.xrl", 15).
yyaction_8(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_9/0}).
-file("./data_scanner.xrl", 16).
yyaction_9() ->
     skip_token .

-compile({inline,yyaction_10/0}).
-file("./data_scanner.xrl", 17).
yyaction_10() ->
     skip_token .

-compile({inline,yyaction_11/1}).
-file("./data_scanner.xrl", 18).
yyaction_11(TokenLine) ->
     { end_token, { newline, TokenLine } } .

-file("/usr/lib/erlang/lib/parsetools-2.0.1/include/leexinc.hrl", 282).
